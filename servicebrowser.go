...
// ServiceBrowser discovers network services of a specified type.
//
// The service type is a DNS-SD service name, such as "_http._tcp" or
// "_ipp._tcp". Subtypes (e.g., "_universal._sub._ipp._tcp") are also
// supported.
//
// When a service is discovered, the corresponding [ServiceBrowserEvent]
// contains two type fields:
//   - SvcSubType - always matches the exact type or subtype requested by
//     the caller.
//   - SvcType    - always contains the base service type (without subtype
//     prefix).
//
// For example, if the requested type is "_universal._sub._ipp._tcp", then:
//   - SvcSubType = "_universal._sub._ipp._tcp"
//   - SvcType    = "_ipp._tcp"
type ServiceBrowser struct {
	clnt             *Client                          // Owning Client
	svcTypeRequested string                           // Requested svctype
...
type ServiceBrowserEvent struct {
	...
	SvcSubType   string            // Service subtype (e.g. "_universal._sub._ipp._tcp")
...
func NewServiceBrowser(
	...
	browser := &ServiceBrowser{clnt: clnt, svcTypeRequested: svctype}
...
func serviceBrowserCallback(
	...
	evnt := &ServiceBrowserEvent{
		...
		SvcSubType:   browser.svcTypeRequested,
